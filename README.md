...
unms-ros-sync syncs clients from UNMS to Mikrotik routerOS router (currently supports pppoe clients only, if you need anything else please contact me). Script schedules a crontab with a 1 minute interval.\
